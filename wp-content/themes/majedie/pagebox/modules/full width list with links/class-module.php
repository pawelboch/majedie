...
*/
namespace Majedie\Pagebox\Modules\fullWidthListWithLinks;
	...
	*/
	public function set_config() {
		$this->config = array(
			...
			'slug'        => 'full_width_list_with_links',
			// Human readable title of box. It will be displayed in all
			// backend functionalities
			'title'       => __(  'About us - menu', 'pagebox_blocks' ),
			...
			'fields'      => array(
				array(
					...
					'name'        => 'links',
					'description' => __( 'Add link', 'pagebox' ),
					'labels'       => array(
						'singular' => __('Link', 'pagebox'),
						'plural' => __('Links', 'pagebox')
					),
					'buttons' => array(
						'add' => __('Add link', 'pagebox'),
						'remove' => __('Remove link', 'pagebox')
					),
					'fields' => array(
						array(
							'type'        => 'text',
