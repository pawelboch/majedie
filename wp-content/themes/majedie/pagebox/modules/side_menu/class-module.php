...
namespace Majedie\Pagebox\Modules\side_menu;
...
class Module extends Abstract_Module {
	...
	public function set_config() {
		...
		$this->config = array(
			...
			'title'       => __(  'Side menu', 'pagebox_blocks' ),
			...
			'fields'      => array(
					...
					'name'        => 'items',
					'description' => __( 'Add menu item', 'pagebox' ),
					'labels'       => array(
						'singular' => __('Item', 'pagebox'),
						'plural' => __('Items', 'pagebox')
					),
					'buttons' => array(
						'add' => __('Add item', 'pagebox'),
						'remove' => __('Remove item', 'pagebox')
					),
					'fields' => array(
