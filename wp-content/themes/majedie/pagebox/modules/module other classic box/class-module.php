...
namespace Majedie\Pagebox\Modules\moduleOtherClassicBox;
...
class Module extends Abstract_Module {
	...
	public function set_config() {
		...
		$this->config = array(
			...
			'slug'        => 'module_other_classic_box',
			// Human readable title of box. It will be displayed in all
			// backend functionalities
			'title'       => __(  'Other classic box', 'pagebox_blocks' ),
