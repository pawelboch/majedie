...
namespace Majedie\Pagebox\Modules\fundBoxPost;
...
class Module extends Abstract_Module {
	...
	public function set_config() {
		...
		$this->config = array(
			...
			'title'       => __(  'Fund box post', 'pagebox_blocks' ),
			// Short description about what box outputs. It will be displayed
			// below the title in new box modal window.
			'description' => __(  'Select news post', 'pagebox_blocks' ),
			...
			'fields'      => array(
				array(
					...
					'description' => __( 'Select post', 'pagebox' ),
				),
			)
		);
	}
