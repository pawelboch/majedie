...
namespace Majedie\Pagebox\Modules\fullWidthTitleParagraphBackgroundImage;
...
class Module extends Abstract_Module {
	...
	public function set_config() {
		...
		$this->config = array(
			...
			'slug'        => 'full_width_title-paragraph-background_image',
			// Human readable title of box. It will be displayed in all
			// backend functionalities
			'title'       => __(  'full width title + paragraph + background image', 'pagebox_blocks' ),
