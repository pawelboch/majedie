...
namespace Majedie\Pagebox\Modules\fullWidthBlockWithLogoTitleButtonBackgroundImage;
...
class Module extends Abstract_Module {
	...
	public function set_config() {
		...
		$this->config = array(
			...
			'slug'        => 'full_width_block_with_logo-title-button-background_image',
			// Human readable title of box. It will be displayed in all
			// backend functionalities
			'title'       => __(  'MajiQ and About Us - one block', 'pagebox_blocks' ),
