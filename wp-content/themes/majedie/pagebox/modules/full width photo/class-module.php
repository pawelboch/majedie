...
namespace Majedie\Pagebox\Modules\fullWidthPhoto;
...
class Module extends Abstract_Module {
	...
	public function set_config() {
		...
		$this->config = array(
			...
			'slug'        => 'full_width_photo',
			// Human readable title of box. It will be displayed in all
			// backend functionalities
			'title'       => __(  'Big Image', 'pagebox_blocks' ),
			...
			'fields'      => array(
				...
				array(
					...
					'name'        => 'height',
					'label'       => __( 'Height', 'pagebox' ),
					'description' => __( 'Height of module section', 'pagebox' ),
				),
			)
		);
	}
