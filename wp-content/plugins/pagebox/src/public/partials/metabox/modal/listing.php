		...
		<div id="pagebox-modules" class="pagebox-tab">
			...
			<ul>
				<?php 
					...
					// limit available modules to ones that fit into the parent element
					/*if ( ! ( $_REQUEST[ 'target' ][ 'width' ] >= $moduleConfig[ 'width' ][ 0 ] && 
						$_REQUEST[ 'target' ][ 'width' ] <= $moduleConfig[ 'width' ][ 1 ] ) ) {
						continue;
					}*/
				?>
