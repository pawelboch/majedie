...
class WPGeeks_HTML 
{
    ...
    {
        // check if it is true false attribute
        if (array_key_exists($attribute, $this->booleanAttributes)) {

            if ($value == true) {
                $this->attributes[$attribute] = $this->booleanAttributes[$attribute][0];
            } else if ($value == false && isset($this->booleanAttributes[$attribute][1])) {
                $this->attributes[$attribute] = $this->booleanAttributes[$attribute][1];
            } else if ($value == false) {
