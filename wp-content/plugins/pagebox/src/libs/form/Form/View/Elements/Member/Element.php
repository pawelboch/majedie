...
?>
<table>
	<tr class="subelement-member" data-type="member">
		...
		<td class="input">
			...
			?>
                        <select data-setting="member" class="make-chosen" name="<?php echo $this->getConfig( 'name' ); ?>" class="subelement" >
                                <option value=""></option>
			...
			<p class="description">
				<?php _e( 'Select specific member name to display', 'pagebox' ); ?>
			</p>
		</td>
	</tr>
</table>