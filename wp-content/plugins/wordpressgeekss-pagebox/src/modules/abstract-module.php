...
abstract class Module {
	...
	public function set_form() {
		...
		$this->config[ 'fields' ] = apply_filters( 'pagebox/module/fields', isset( $this->config[ 'fields' ] ) ? (array) $this->config[ 'fields' ] : array(), $this->get_slug() );
	...
	public function display_frontend() {
		...
		do_action( 'pagebox/module/view/before', $this->get_slug(), $this->data->settings );
		...
		do_action( 'pagebox/module/view/after', $this->get_slug(), $this->data->settings );
