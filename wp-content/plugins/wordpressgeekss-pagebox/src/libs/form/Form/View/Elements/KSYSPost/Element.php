...
<table>
	...
	<tr class="subelement-post" data-type="post">
		...
		<td class="input">
			...
			?>
			<select data-setting="post" name="<?php echo $this->getConfig( 'name' ); ?>[post]" class="make-chosen">
				<option value=""></option>

				<?php foreach ($this->posts as $post): ?>

				<option value="<?php echo $post->ID; ?>" <?php selected($post->ID, $this->values['post']); ?>>
					<?php echo str_replace(array('\'', '"', '&quot;'), '', $post->post_title); ?>
				</option>
	...
	<tr class="subelement-categories" data-type="post">
		...
		<td class="input">
			...
			?>
			<select data-setting="category" name="<?php echo $this->getConfig( 'name' ); ?>[category]" multiple class="make-chosen">
				<option value=""></option>
	...
	<tr class="subelement-tags" data-type="post">
		...
		<td class="input">
			...
			?>
			<select data-setting="tag" name="<?php echo $this->getConfig( 'name' ); ?>[tag]" multiple class="make-chosen">
				<option value=""></option>
