...
<tr class="row element-<?php echo $this->getConfig('type'); ?>" data-element="<?php echo $this->getConfig('type'); ?>" data-conditions="<?php echo esc_attr( wp_json_encode( $this->getConfig( 'conditions' ) ) ); ?>">
