...
class WPGeeks_Form_Element_Repeater extends WPGeeks_Form_Element
{
    ...
    public function renderBoilerplate()
    {
      ...
      //  $boilerplate .= $this->element->getRenderedTag();
        foreach ($group as $element) {
           // if()
            $boilerplate .= print_r($element->element->type,1);

            $element->setValue('');
            $boilerplate .= $element->renderRow();
            //$boilerplate .= $element->getRenderedClosingTag();
        }
     //   $boilerplate .= $this->element->getRenderedClosingTag();
